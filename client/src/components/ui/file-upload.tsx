    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans text-base font-semibold text-neutral-700">
            上传资料
          </p>
          <p className="relative z-20 mt-2 font-sans text-sm font-normal text-neutral-400">
            拖拽文件到此处，或点击选择文件
          </p>
          <div className="relative mx-auto mt-10 w-full max-w-xl">
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute inset-0 z-30 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md border border-dashed border-slate-400 bg-transparent opacity-0"
              ></motion.div>
            )}
          </div>
        </div>
